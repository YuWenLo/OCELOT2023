...
# from user.fc.fchardnet import PytorchaFcCellModel as Model
from user.fc.fchardnet_5fold import PytorchaFcCellModel as Model
# from user.fc.fchardnet_5fold_1ch import PytorchaFcCellModel as Model
